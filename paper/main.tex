...
\begin{axis}[
    ...
    \addplot table[x=scoreName, y=All, col sep=comma]{defect-categories.csv};
    \addplot table[x=scoreName, y=TypeError, col sep=comma]{defect-categories.csv};
    \addplot table[x=scoreName, y=AttributeError, col sep=comma]{defect-categories.csv};
\legend{All Errors,TypeError,AttributeError}
\end{axis}
\end{tikzpicture}
