...
PLOT Type: Bar Graph (with multiple bars) 

PLOT Y Axis: Model Accuracy

PLOT X Axis: Top-1, Top-2, Top3

PLOT Bars: 1 for our algorithm, 1 for a weak baseline (such as the vanilla
Python interpreter) 
...
Ranjit: ``our algorithms'' --- ``purely syntactic vs. with types'' 
--- ``with or without slicing'' as extra ``bars'' 
...
TABLE COLUMNS: Feature Name, Feature Category, Feature Predictive Power

TABLE ROWS: top twelve features
