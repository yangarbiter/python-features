...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot table[x=threshold, y=python_twenty_cluster_counts_\method, col sep=comma]{cluster_counts.csv};
\end{axis}
\end{tikzpicture}
}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    {
      \addplot table[x=threshold, y=\language_cluster_counts_\method, col sep=comma]{cluster_counts.csv};
    }
\legend{OCaml, Python}
\end{axis}
\end{tikzpicture}
